...
\fancyhead[L]{{{\makebox[50em][l]{\Large   \bfseries \heiti HPMicro微控制器应用笔记}
        }
        {\normalsize \heiti 应用笔记模板 Rev1.0\makebox[2.8em][r]{}} {\small  \heiti \color{black} \hfill \leftmark }\vspace{3pt}}
