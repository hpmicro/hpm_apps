...
#define FOE_FILE_ADDR       (FLASH_ADDR_BASE + FLASH_USER_APP1_ADDR)
#define FOE_FILE_TOTAL_SIZE (FLASH_ADDR_BASE + FLASH_USER_APP1_ADDR + FLASH_USER_APP1_SIZE) /* end address */
