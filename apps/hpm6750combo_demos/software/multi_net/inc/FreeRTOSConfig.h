...
extern uint32_t get_hires_tick(void);

extern void hires_tick_config(void);

#define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS  hires_tick_config
#define portGET_RUN_TIME_COUNTER_VALUE          get_hires_tick
...
#define uartPRIMARY_PRIORITY                (configMAX_PRIORITIES - 20)
#endif
