...
/* CPU usage counter. */
extern volatile uint32_t g_freertos_run_time_counter;
#define portCONFIGURE_TIMER_FOR_RUN_TIME_STATS()  (g_freertos_run_time_counter = 0)
#define portGET_RUN_TIME_COUNTER_VALUE()          g_freertos_run_time_counter
