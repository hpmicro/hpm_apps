...
![ctlboard](../../../api/assets/ctlboard.jpg)
...
![Device Connection](../../../api/assets/test_env.jpg)
...
![Res_dnp](../../../api/assets/Res_dnp.jpg)
...
![windows GUI create project](../../../api/assets/sei_build.png)  

- windows cmd create project
  Please read [HPM5300_DCServo User Guide](../../../HPM5300_DCServo_UG.pdf)
...
![PC](../../../api/assets/elf_json.png) 

- Click the device and connect the communication

![uart_connect](../../../api/assets/uart_connect.png) 

- add params

![params1](../../../api/assets/param_config_en_1.png) 

![params2](../../../api/assets/param_config_en_2.png) 
