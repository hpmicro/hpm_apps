...
hpm_stat_t ecat_hardware_init(ESC_Type *esc_ptr)
{
    ...
    esc_config_ctrl_signal_function(esc_ptr, BOARD_ECAT_ACT0_CTRL_INDEX, esc_ctrl_signal_func_alt_link_act0, false); /* ACT0 */
#if defined(BOARD_ECAT_SUPPORT_PORT1) && BOARD_ECAT_SUPPORT_PORT1
    esc_config_ctrl_signal_function(esc_ptr, BOARD_ECAT_NMII_LINK1_CTRL_INDEX, esc_ctrl_signal_func_alt_nmii_link1, false); /* NMII_LINK1 */
    esc_config_ctrl_signal_function(esc_ptr, BOARD_ECAT_ACT1_CTRL_INDEX, esc_ctrl_signal_func_alt_link_act1, true); /* ACT1 */
#endif
    ...
    esc_config_ctrl_signal_function(esc_ptr, BOARD_ECAT_ACT2_CTRL_INDEX, esc_ctrl_signal_func_alt_link_act2, true); /* ACT2 */
#endif
    esc_config_nmii_link_source(esc_ptr, true, BOARD_ECAT_SUPPORT_PORT1, BOARD_ECAT_SUPPORT_PORT2); /* configure nmii_link source */

    esc_config_ctrl_signal_function(esc_ptr, BOARD_ECAT_LED_RUN_CTRL_INDEX, esc_ctrl_signal_func_alt_led_run, true);   /* LED_RUN */
    esc_config_ctrl_signal_function(esc_ptr, BOARD_ECAT_LED_ERROR_CTRL_INDEX, esc_ctrl_signal_func_alt_led_err, true); /* LED_ERROR */
