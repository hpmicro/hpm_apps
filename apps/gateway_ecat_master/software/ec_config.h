...
#define CONFIG_EC_NONPERIOD_STACKSIZE 1024*10
#endif
...
#define CONFIG_EC_SCAN_STACKSIZE 1024*10
#endif
...
#define CONFIG_EC_PER_SM_MAX_PDOS 16
#endif

#ifndef CONFIG_EC_PER_PDO_MAX_PDO_ENTRIES
#define CONFIG_EC_PER_PDO_MAX_PDO_ENTRIES 32
#endif

//#define CONFIG_EC_PERF_ENABLE
#define CONFIG_EC_CMD_ENABLE 1
