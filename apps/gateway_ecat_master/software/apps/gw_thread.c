...
static gw_thread gw_thread_list[] =
{
    ...
    {NULL, gw_ecat_master_thread,  NULL, {.name="gw_thread_ecat_master",  .stack_size = GW_THREAD_ECAT_MASTER_STACK_SIZE,  .priority = GW_THREAD_ECAT_MASTER_PRIORITY}},
    {NULL, gw_lcd_thread,  NULL, {.name="gw_thread_lcd",  .stack_size = GW_THREAD_LCD_STACK_SIZE,  .priority = GW_THREAD_LCD_PRIORITY, .attr_bits = osThreadDetached}},
