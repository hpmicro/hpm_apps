...
{
    qeiv2_init();
    trgm_pos_matrix_config(HPM_TRGM0, trgm_pos_matrix_output_to_sei_pos1, trgm_pos_matrix_in_from_qei1, false);
}
void sei_slave_tamagawa_init(void)
{
    ...
    tranceiver_config.asynchronous_config.baudrate = 115200;//2500000;
    ...
    /* [3] instructions */
    instr_idx = 0;
    sei_set_instr(BOARD_SEI, instr_idx++, SEI_INSTR_OP_RECV_WDG, 0, SEI_DAT_9, SEI_DAT_1, 8);                         /* Recv CF */
