 ...
 *---------------------------------------------------------------------*/
/**
 * @brief Callback function of timer;定时器回调函数
 */
...
/**
 * @brief Get system's tick value;获取系统定时器的tick
 *
 * @return System's tick value;系统定时器tick值
 */
 ...
 *---------------------------------------------------------------------*/
/**
 * @brief LED blink time set when device mounted;设备装载LED闪烁间隔设置
 */
...
/**
 * @brief LED blink time set when device unmounted;设备卸载LED闪烁间隔设置
 */
