...
/*QEI*/
#define BOARD_BLDC_QEI_BASE              HPM_QEI0//HPM_QEI1
#define BOARD_BLDC_QEI_IRQ               IRQn_QEI0//IRQn_QEI1
...
#define BOARD_PMSM0_ADC_CH_U                    (2U)//(5U)//
#define BOARD_PMSM0_ADC_CH_V                    (3U)//(6U)//
#define BOARD_PMSM0_ADC_CH_W                    (4U)//(15U)//(7U)//
...
#define BOARD_PMSM0_UH_PWM_OUTPIN         (0U)//(6U)//
#define BOARD_PMSM0_UL_PWM_OUTPIN         (1U)//(7U)//
#define BOARD_PMSM0_VH_PWM_OUTPIN         (4U)//(4U)//
#define BOARD_PMSM0_VL_PWM_OUTPIN         (5U)//(5U)//
#define BOARD_PMSM0_WH_PWM_OUTPIN         (6U)//(2U)//
#define BOARD_PMSM0_WL_PWM_OUTPIN         (7U)//(3U)//
#define BOARD_PMSM0PWM_TRGM                HPM_TRGM0//HPM_TRGM0
#define BOARD_PMSM0APP_PWM_IRQ             IRQn_PWM0//IRQn_PWM0
#define BOARD_PMSM0PWM_CMP_INDEX_0         (0U)//(6U)//
#define BOARD_PMSM0PWM_CMP_INDEX_1         (1U)//(7U)//
#define BOARD_PMSM0PWM_CMP_INDEX_2         (4U)//(4U)//
#define BOARD_PMSM0PWM_CMP_INDEX_3         (5U)//(5U)//
#define BOARD_PMSM0PWM_CMP_INDEX_4         (6U)//(2U)//
#define BOARD_PMSM0PWM_CMP_INDEX_5         (7U)//(3U)//
//#define BOARD_BLDCPWM_CMP_TRIG_CMP        (15U)
#define BOARD_BLDC_ADC_SEQ_DMA_SIZE_IN_4BYTES  (40U)


/*PMSM0 QEI*/
#define BOARD_PMSM0_QEI_BASE             BOARD_BLDC_QEI_BASE//HPM_QEI0//
#define BOARD_PMSM0_QEI_IRQ               BOARD_BLDC_QEI_IRQ//IRQn_QEI0//
