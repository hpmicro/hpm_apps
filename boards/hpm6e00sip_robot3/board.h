...
#define BOARD_APP_I2S_DATA_LINE      I2S_DATA_LINE_0
...
#define BOARD_APP_SPI_IRQ               IRQn_SPI0
#define BOARD_APP_SPI_SCLK_FREQ         (5000000UL)
//#define BOARD_APP_SPI_ADDR_LEN_IN_BYTES (2U)
#define BOARD_APP_SPI_DATA_LEN_IN_BITS  (24U)
#define BOARD_APP_SPI_RX_DMA            HPM_DMA_SRC_SPI0_RX
#define BOARD_APP_SPI_TX_DMA            HPM_DMA_SRC_SPI0_TX
#define BOARD_SPI_CS_GPIO_CTRL          HPM_GPIO0
#define BOARD_SPI_CS_PIN                IOC_PAD_PC21
...
#define BOARD_APP_SPI_ADDR_LEN_IN_BYTES (2U)
#define BOARD_APP_SPI_DATA_LEN_IN_BITS  (16U)
...
#define BOARD_ECAT_PHY0_RESET_GPIO_PORT_INDEX GPIO_DI_GPIOV
#define BOARD_ECAT_PHY0_RESET_PIN_INDEX       (12)

#define BOARD_ECAT_PHY1_RESET_GPIO            HPM_GPIO0
#define BOARD_ECAT_PHY1_RESET_GPIO_PORT_INDEX GPIO_DI_GPIOW
...
#if USE_MOTOR_DM
#define BOARD_PMSM0_ADC_U_BASE                  HPM_ADC2
#define BOARD_PMSM0_ADC_V_BASE                  HPM_ADC3
#else
#define BOARD_PMSM0_ADC_U_BASE                  HPM_ADC0
#define BOARD_PMSM0_ADC_V_BASE                  HPM_ADC1
#endif
...
#define BOARD_APP_ADC16_UDC_CH                  (7U)
#define BOARD_APP_ADC16_TEMP_CH                 (1U)
...
#if USE_MOTOR_DM
#define BOARD_PMSM0_ADC_CH_U                    (4U)
#define BOARD_PMSM0_ADC_CH_V                    (5U)
#else
#define BOARD_PMSM0_ADC_CH_U                    (14U)
#define BOARD_PMSM0_ADC_CH_V                    (10U)
#endif

#define BOARD_PMSM0_ADC_CH_W                    (11U)
#define BOARD_PMSM0_ADC_IRQn                    IRQn_ADC0
...
#define BOARD_PMSM0_PWM_TRIG_CMP_INDEX          (16U)
#define BOARD_PMSM0_PWM_TRIG_CMP_INDEX_CURRENTLOOP          (17U)
#define BOARD_PMSM0_TRIGMUX_IN_NUM              HPM_TRGM0_INPUT_SRC_PWM0_TRGO_0
#define BOARD_PMSM0_TRG_NUM                     TRGM_TRGOCFG_ADCX_PTRGI0A
#define BOARD_PMSM0_PWM_TRIGOUT_CH_ADC           (0U)
#define BOARD_PMSM0_PWM_TRIGOUT_CH_CURRENTLOOP   (1U)
/*PMSM0 PWM*/
...
#define pwm_output_0                        (0U)
#define PWM_DEAD_AREA_TICK                  (200)
#define PWM_CNT0                            pwm_counter_0
#define BOARD_BLDC_PWM_TRIG_OUT_CHN           (0U)
/*PMSM0 QEI*/
#define BOARD_PMSM0_QEI_BASE                HPM_QEI0
#define BOARD_PMSM0_QEI_IRQ                 IRQn_QEI0
#define BOARD_PMSM0_ENCODER_TYPE            0//0:SPI, 1:ABZ
#define BOARD_PMSM0_ENCODER_TYPE_SET        0//0:SPI, 1:ABZ
...
#define BOARD_PMSM0_SPI_FOC_PHASE_COUNT_PER_REV       (16384U)
/*pwm cmp set*/
...
#define HPM_PMSM_ECAT_VERSION               (2043)    //软件版本号
//#define BOARD_PMSM0_SPI_FOC_OR_ABZ            (1)//1:SPI, 0:ABZ
#define BOARD_PMSM0_CLC_3P3Z                  (1)//0:pi 1:3P3Z with CLC
#define BOARD_PMSM0_INTERIA                   (0)//0:interia disable 1:interia enable
#define BOARD_PMSM0_PICONTROL_PARMA_UPDATE    (0)//0:pi control parma by init 1:pi control parma can be changed by COE

#define USE_HPMMONITOR                         0
