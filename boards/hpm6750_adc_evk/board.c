...
void board_init_led_pins(void)
{
    ...
    gpio_set_pin_output_with_initial(BOARD_LED_GPIO_CTRL, BOARD_LED_GPIO_INDEX, BOARD_LED_GPIO_PIN, BOARD_LED_OFF_LEVEL);
}
...
void board_led_toggle(void)
{
    ...
    if(BOARD_LED_PULL_STATUS){
        ...
        gpio_write_port(BOARD_LED_GPIO_CTRL, BOARD_LED_GPIO_INDEX, (7 & ~(1 << i)) << BOARD_LED_GPIO_PIN);
    }
    else{
        /* hpm6750 Mini Rev B led configure*/
        gpio_write_port(BOARD_LED_GPIO_CTRL, BOARD_LED_GPIO_INDEX, ((1 << i)) << BOARD_LED_GPIO_PIN);
    }
    i++;
    i = i % 3;
}
