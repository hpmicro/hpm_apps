...
void init_sdxc_pins(SDXC_Type *ptr, bool use_1v8)
{
    ...
    if (ptr == HPM_SDXC0) {
        ...
        HPM_IOC->PAD[IOC_PAD_PE22].PAD_CTL = pad_ctl;
        ...
        HPM_GPIO0->OE[GPIO_OE_GPIOE].CLEAR = 1UL << BOARD_APP_SDCARD_CARD_DETECTION_PIN_INDEX;
		
		/* SDXC1.VSEL */
	    // HPM_IOC->PAD[IOC_PAD_PD13].FUNC_CTL = IOC_PD13_FUNC_CTL_SDC1_;
	    // HPM_IOC->PAD[IOC_PAD_PD13].PAD_CTL = IOC_PAD_PAD_CTL_DS_SET(6) | IOC_PAD_PAD_CTL_PE_SET(1) | IOC_PAD_PAD_CTL_PS_SET(1);
