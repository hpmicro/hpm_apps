...
#define BOARD_STEPPER0_A0H_PWM_OUTPIN         (4U)//pwm_VH
#define BOARD_STEPPER0_A0L_PWM_OUTPIN         (5U)//pwm_VL
#define BOARD_STEPPER0_B0H_PWM_OUTPIN         (2U)//PWM_WH
#define BOARD_STEPPER0_B0L_PWM_OUTPIN         (3U)//PWM_WL
#define BOARD_STEPPER0PWM_TRGM                HPM_TRGM0
#define BOARD_STEPPER0APP_PWM_IRQ             IRQn_PWM0
...
#define BOARD_STEPPER0_ADC_CH_A                    (5U)
#define BOARD_STEPPER0_ADC_CH_B                    (6U)
#define BOARD_STEPPER0_ADC_IRQn                    IRQn_ADC1
#define BOARD_STEPPER0_ADC_SEQ_DMA_SIZE_IN_4BYTES  (40U)
#define BOARD_STEPPER0_ADC_TRG                     ADC16_CONFIG_TRG0A
...
#define BOARD_STEPPER0_TRIGMUX_IN_NUM              HPM_TRGM0_INPUT_SRC_PWM0_CH8REF
#define BOARD_STEPPER0_TRG_NUM                     TRGM_TRGOCFG_ADCX_PTRGI0A

#define MOTOR_STEPPER_PWM_SYNC                     HPM_SYNT

/*qeiv*/
#define BOARD_STEPPER_QEI                          BOARD_BLDC_QEIV2_BASE
#define BOARD_STEPPER_QEI_FOC_PHASE_COUNT_MAX      BOARD_BLDC_QEI_FOC_PHASE_COUNT_PER_REV

/*timer*/
#define BOARD_STEPPER_TMR_1MS                    BOARD_BLDC_TMR_1MS
#define BOARD_STEPPER_TMR_CH                     BOARD_BLDC_TMR_CH
#define BOARD_STEPPER_TMR_CMP                    BOARD_BLDC_TMR_CMP
#define BOARD_STEPPER_TMR_IRQ                    BOARD_BLDC_TMR_IRQ
#define BOARD_STEPPER_TMR_RELOAD                 BOARD_BLDC_TMR_RELOAD               
