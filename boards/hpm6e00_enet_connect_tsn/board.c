...
void board_init_led(void)
{
    ...
    /* led0 */
    gpio_set_pin_output_with_initial(BOARD_LED0_GPIO_CTRL, BOARD_LED0_GPIO_INDEX, BOARD_LED0_GPIO_PIN, true);
    /* led1 */
    gpio_set_pin_output_with_initial(BOARD_LED1_GPIO_CTRL, BOARD_LED1_GPIO_INDEX, BOARD_LED1_GPIO_PIN, true);
}
...
void board_init_oled(void)
{
    ...
    /* oled comm spi mode */
    gpio_set_pin_output_with_initial(BOARD_OLED_BS0_CTRL, BOARD_OLED_BS0_INDEX, BOARD_OLED_BS0_PIN, false);
    gpio_set_pin_output_with_initial(BOARD_OLED_BS1_CTRL, BOARD_OLED_BS1_INDEX, BOARD_OLED_BS1_PIN, false);
    
    /* oled d/c */
    gpio_set_pin_output_with_initial(BOARD_OLED_D_C_CTRL, BOARD_OLED_D_C_INDEX, BOARD_OLED_D_C_PIN, true);
    /* oled reset */
    gpio_set_pin_output_with_initial(BOARD_OLED_RESET_CTRL, BOARD_OLED_RESET_INDEX, BOARD_OLED_RESET_PIN, false);

    clock_add_to_group(BOARD_OLED_SPI_CLK_NAME, 0);
}
...
void board_init_clock(void)
{
    ...
    clock_connect_group_to_cpu(1, 0);
...
void board_init_tsw(void)
{
    ...
    board_delay_ms(10);
    board_tsw_phy_set(0, true);
    board_tsw_phy_set(1, true);
...
{
    if (ptr == HPM_ENET0) {
        intc_m_enable_irq_with_priority(IRQn_ENET0, 7);
    } else {
