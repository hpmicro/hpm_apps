...
void init_ddr_sip(void)
{
    /* Enable On-chip DCDC 1.4V output */
    HPM_PCFG->DCDCM_MODE = PCFG_DCDCM_MODE_VOLT_SET(1400) | PCFG_DCDCM_MODE_MODE_SET(5);

    /* Change DDR clock to 400MHz, namely: DDR3-1600 */
    clock_set_source_divider(clock_axif, clk_src_pll1_clk0, 2);
    ...
    *(volatile uint32_t *) (HPM_DDRPHY_BASE + 0x3000UL) |= (1UL << 4);
    ...
    /* DDR PHY configuration for DDR-SIP part */
    *(volatile uint32_t *) (HPM_DDRPHY_BASE + 0x3010) = 0x30756812; /* dq7-0 */
    *(volatile uint32_t *) (HPM_DDRPHY_BASE + 0x3014) = 0x78043215; /* dq15-8 */
    *(volatile uint32_t *) (HPM_DDRPHY_BASE + 0x3018) = 0x64482610; /* dm1;dm0;ODT1;ODT0;CS1;cs0;cke1;cke0 */
    *(volatile uint32_t *) (HPM_DDRPHY_BASE + 0x301C) = 0x49857;    /* [18]a10_opt_sel;we;a10_opt;cas;ras */
    *(volatile uint32_t *) (HPM_DDRPHY_BASE + 0x3030) = 0x13121110; /* BA2;BA1;ba0 */
    *(volatile uint32_t *) (HPM_DDRPHY_BASE + 0x302C) = 0x0C000903; /* A15;A14;A13;A12 */
    *(volatile uint32_t *) (HPM_DDRPHY_BASE + 0x3028) = 0x0407060B; /* A11;A10;A9;A8 */
    *(volatile uint32_t *) (HPM_DDRPHY_BASE + 0x3024) = 0x01080504; /* A7;A6;A5;A4 */
    *(volatile uint32_t *) (HPM_DDRPHY_BASE + 0x3020) = 0x02100D12; /* A3;A2;A1;A0 */
