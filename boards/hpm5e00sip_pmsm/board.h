...
#define BOARD_PLB_TRGM_FILTER_GPIO_INPUT0  HPM_TRGM0_FILTER_SRC_TRGM_P_00
...
#define BOARD_APP_PWM_FAULT_PIN         (7)
...
/* BLDC TRGM */
#define BOARD_BLDC_TRIGMUX_IN_NUM      HPM_TRGM0_INPUT_SRC_PWM0_TRGO_0
...
#define BOARD_APP_QEI_TRIGMUX_OUT_NUM_ADC     HPM_TRGM0_OUTPUT_SRC_ADCX_PTRGI0A
...
#define BOARD_LOBS_TRIG_PIN_0 26
#define BOARD_LOBS_TRIG_PIN_1 27
...
#define BOARD_PPI_ASYNC_SRAM_SIZE         (128 * SIZE_1KB)
...
#define BOARD_PMSM0_ADC_CH_U                    (12U)
#define BOARD_PMSM0_ADC_CH_V                    (11U)
...
#define BOARD_PMSM0_ENCODER_TYPE            1//0:SPI, 1:ABZ
...
#define HPM_PMSM_ECAT_VERSION                   (2047)    //软件版本号
#define BOARD_PMSM0_SPI_FOC_OR_ABZ              (1)//1:SPI, 0:ABZ
#define BOARD_PMSM0_CLC_3P3Z                  (0)//(1)//0:pi 1:3P3Z with CLC
#define BOARD_PMSM0_INTERIA                   (1)//0:interia disable 1:interia enable
