...
void init_esc_sip_pins(void)
{
    ...
    HPM_IOC->PAD[IOC_PAD_PE00].FUNC_CTL = IOC_PE00_FUNC_CTL_ESC0_CTR_4; /* LED_RUN */
    HPM_IOC->PAD[IOC_PAD_PE01].FUNC_CTL = IOC_PE01_FUNC_CTL_ESC0_CTR_5; /* LED_ERR */

    HPM_IOC->PAD[IOC_PAD_PB25].FUNC_CTL = IOC_PAD_FUNC_CTL_ANALOG_MASK;
    HPM_IOC->PAD[IOC_PAD_PC20].FUNC_CTL = IOC_PAD_FUNC_CTL_ANALOG_MASK;
    ...
    HPM_IOC->PAD[IOC_PAD_PA25].FUNC_CTL = IOC_PA25_FUNC_CTL_GPIO_A_25; /* PHY1 LED1 */
    gpio_set_pin_output_with_initial(HPM_GPIO0, GPIO_DO_GPIOA, 25, 1);
    HPM_IOC->PAD[IOC_PAD_PA26].FUNC_CTL = IOC_PA26_FUNC_CTL_GPIO_A_26; /* PHY1 LED0 */
    gpio_set_pin_output_with_initial(HPM_GPIO0, GPIO_DO_GPIOA, 26, 0);
    ...
    HPM_IOC->PAD[IOC_PAD_PA28].FUNC_CTL = IOC_PA28_FUNC_CTL_GPIO_A_28; /* PHY0 LED1 */
    gpio_set_pin_output_with_initial(HPM_GPIO0, GPIO_DO_GPIOA, 28, 0);
    HPM_IOC->PAD[IOC_PAD_PA29].FUNC_CTL = IOC_PA29_FUNC_CTL_GPIO_A_29; /* PHY0 LED0 */
    gpio_set_pin_output_with_initial(HPM_GPIO0, GPIO_DO_GPIOA, 29, 1);
