...
#else
    IP_ADDR4(&ipaddr, MONITOR_ENET_IP_ADDR0, MONITOR_ENET_IP_ADDR1, MONITOR_ENET_IP_ADDR2, MONITOR_ENET_IP_ADDR3);
    IP_ADDR4(&netmask, MONITOR_NETMASK_ADDR0, MONITOR_NETMASK_ADDR1, MONITOR_NETMASK_ADDR2, MONITOR_NETMASK_ADDR3);
    IP_ADDR4(&gw, MONITOR_ENET_GW_ADDR0, MONITOR_ENET_GW_ADDR1, MONITOR_ENET_GW_ADDR2, MONITOR_ENET_GW_ADDR3);
#endif
