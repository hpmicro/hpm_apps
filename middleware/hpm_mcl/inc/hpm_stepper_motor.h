...
typedef struct  stepper_contrl_spd_cal_par {
    ...
    STEPPER_MOTOR_PARA     *i_motorpar;                /**< Motor operating parameters */
    void    (*func_getspd)();                     /**< Speed calculation function */
} STEPPER_CONTRL_SPD_CAL_PARA;
#define STEPPER_CONTRL_SPD_CAL_PARA_DEFAULTS {0, 0, 0, 0, 0,\
                                        0, 0, 0, 0, NULL,\
...
typedef struct stepper_contrl_foc_par{
    ...
    STEPPER_CONTRL_PID_PARA        currentspeedpar; 
    STEPPER_CONTRL_SPD_CAL_PARA        speedcalpar;
...
#define STEPPER_CONTROL_FOC_PARA_DEFAULTS {STEPPER_CONTRL_PID_PARA_DEFAULTS,STEPPER_CONTRL_PID_PARA_DEFAULTS,\
                                        STEPPER_CONTRL_PID_PARA_DEFAULTS,STEPPER_CONTRL_SPD_CAL_PARA_DEFAULTS,\
...
void hpm_stepper_svpwm(STEPPER_CONTROL_PWM_PARA *par);
...
void hpm_mcl_stepper_foc_al_speed(STEPPER_CONTRL_SPD_CAL_PARA  *par);
...
void hpm_stepper_alphabeta_dq( HPM_MOTOR_MATH_TYPE currentalpha, HPM_MOTOR_MATH_TYPE currentbeta, HPM_MOTOR_MATH_TYPE angle ,
    HPM_MOTOR_MATH_TYPE * currentd, HPM_MOTOR_MATH_TYPE * currentq);
void hpm_stepper_dq_to_alphabeta(HPM_MOTOR_MATH_TYPE ud, HPM_MOTOR_MATH_TYPE uq,\
    HPM_MOTOR_MATH_TYPE *ualpha, HPM_MOTOR_MATH_TYPE *ubeta, HPM_MOTOR_MATH_TYPE angle);
